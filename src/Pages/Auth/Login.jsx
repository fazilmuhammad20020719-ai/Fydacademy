...
const Login = () => {
  return (
    <div className="min-h-screen bg-white dark:bg-black flex flex-col justify-center py-20 px-6 lg:px-8 relative transition-colors duration-300">
      ...
      {/* Decorative Glows */}
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#fa4616]/10 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-[#fa4616]/5 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        ...
        <h2 className="text-center text-4xl font-black text-zinc-900 dark:text-white tracking-tighter transition-colors">
          Welcome <span className="text-[#fa4616]">Back</span>
        </h2>
        <p className="mt-2 text-center text-sm text-zinc-500 font-medium">
          Don't have an account?{' '}
          <Link to="/register" className="font-black text-[#fa4616] hover:text-[#ff8c00] transition-colors underline decoration-[#fa4616]/30 underline-offset-4">
            Join the Academy
          </Link>
        </p>
      </div>
          ...
          <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="flex items-center justify-between px-1">
              <div className="flex items-center">
                ...
                />
                <label htmlFor="remember-me" className="ml-2 block text-sm text-zinc-600 dark:text-zinc-400 font-medium cursor-pointer transition-colors">
                  Remember me
                </label>
              </div>

              <div className="text-sm">
                <a href="#" className="font-bold text-[#fa4616] hover:text-[#ff8c00] transition-colors">
                  Forgot password?
                </a>
              </div>
            </div>
